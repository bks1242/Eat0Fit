...
var RecipeListComponent = /** @class */ (function () {
    function RecipeListComponent() {
        this.recipes = [
            new _recipe_model__WEBPACK_IMPORTED_MODULE_1__["Recipe"]('Shahi Paneer', 'Test description for shahi paneer', 'https://grofers.com/recipe/wp-content/uploads/2017/01/45-1.jpg?x84191')
        ];
    }
...
var Recipe = /** @class */ (function () {
    function Recipe(name, description, imgPath) {
        this.name = name;
...
module.exports = __webpack_require__(/*! C:\practise\Angular-Projects\eat0-fit\src\main.ts */"./src/main.ts");
